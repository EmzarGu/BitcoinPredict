...
def train_all_models():
    ...
    # We use a 52-week moving average to define the long-term trend
    ...
    for regime in ['Bull', 'Bear']:
        regime_df = features_df[features_df['Regime'] == regime]
        # We need enough data to train the models
        if len(regime_df) > 50: # Arbitrary threshold
